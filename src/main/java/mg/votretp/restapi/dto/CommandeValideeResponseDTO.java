...
public class CommandeValideeResponseDTO extends RepresentationModel<CommandeValideeResponseDTO> {
    ...
    public CommandeValideeResponseDTO() {
    }

    public CommandeValideeResponseDTO(Long idCommande, Integer numCommande, String status,
